                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Location</h4>
            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="?action=update_location" method="post">
                                    <h4 class="header-title">Thêm Địa Chỉ Công Ty</h4>
                                    <?php while ($show = $location->fetch_assoc()) { ?>
                                        <div class="form-group">
                                            <input type="hidden" name="id_location" value="<?php echo $show['id_location'] ?>">
                                            <label for="example-text-input" class="col-form-label">Địa chỉ mới</label>
                                            <input name="location" value="<?php echo $show['location'] ?>" required="" class="form-control" placeholder="VD: Quế Võ - Bắc Ninh" type="text" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Mô tả</label>
                                            <textarea required="" name="note_location" class="form-control" aria-label="With textarea"><?php echo $show['note_location'] ?></textarea>
                                        </div>
                                    <?php } ?>
