            ...
            <div class="login-box ptb--100">
                <form action="">
                    <div class="login-form-head">
                        ...
                        <p>Hãy bảo vệ tài khoản mật khẩu của bạn tốt nhất</p>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Mật Khẩu Cũ</label>
                            <input name="password_old" type="password" id="exampleInputPassword1">
                            <i class="ti-lock"></i>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword2">Mật Khẩu Mới</label>
                            <input name="password_new" type="password" id="exampleInputPassword2">
                            <i class="ti-lock"></i>
                        </div>
